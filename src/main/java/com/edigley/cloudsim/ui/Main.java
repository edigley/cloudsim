...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		int spotLimit = 128; // 1 | 2 | 10 | 20 | 64 | 128 | 256
		...
		String spt = "input-files/us-east-1.linux." + instanceType + ".csv";
		...
		String spotsimCMD = String.format(cmdPattern, spotLimit, wkl, spt, isd, md, spi, output);
